...
Host your own live version of dr.x with Vercel, Cloudflare Pages, or Docker.
...
If you want to use dr.x as a search engine in your browser, follow these steps:
...
7. Find "dr.x in the list of site search, click on the three dots next to it, and select "Make default".

This will allow you to use dr.x as your default search engine in the browser.
...
We welcome contributions to dr.x Whether it's bug reports, feature requests, or pull requests, all contributions are appreciated.
